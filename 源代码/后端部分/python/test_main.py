...
recommendFile = "TestRecommendFile.csv"
...
# 读取所有交易记录
records = pd.read_csv(directory + tradeRecords, encoding='utf-8', index_col=0)
# 计算聚类指标
...
# 文件读
fundOld = pd.read_csv(directory + "旧基金2.0.csv", encoding="utf-8")
fundNew = pd.read_csv(directory + "新基金2.0.csv", encoding="utf-8")
# RawData = pd.read_csv(directory + "用户记录.csv", encoding='utf-8')
RawData = client
TradeFrame = pd.read_csv(directory + tradeRecords, encoding='utf-8')
...
eigenvectorOld = pd.read_csv(directory + "基金属性_旧基金2.0.csv", encoding="utf-8")
eigenvectorNew = pd.read_csv(directory + "基金属性_新基金2.0.csv", encoding="utf-8")
...
# OldFundFrame.to_csv("TestRecommendList.csv", encoding='utf-8',index=False)
...
# 整合新旧基金
# newFundFrame = pd.read_csv(directory + "recommendFile.csv",encoding='utf-8')
newFundFrame = recommendFrame
Frame = Recommend.FundRecommend(OldFundFrame,newFundFrame)
Frame.to_csv(directory + "TestRecommendRes.csv",encoding='utf-8',index=False)
